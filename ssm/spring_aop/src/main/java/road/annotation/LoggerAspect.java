 ...
 * @AfterThrowing：异常通知，在目标对象方法的catch字句中执行 2、切入点表达式：设置在标识通知的注解的value属性中
...
public class LoggerAspect {
    ...
    //@Before("execution(public int road.annotation.CalculatorImpl.add(int, int))")
    //@Before("execution(* road.annotation.CalculatorImpl.*(..))")
    @Before("pointCut()")
