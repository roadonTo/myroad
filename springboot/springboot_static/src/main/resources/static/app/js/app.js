...
(function($, window, document){
  ...
  function initExternalEvents(calElement){
    ...
    eventAddBtn.click(function(e) {
        ...
        // Initialize the new11 event element
...
(function($, window, document){
   ...
   * Usage
   *   chart = new11 floatChart('#id', 'server/chart-data.php')
   *   ...
...
(function($, window, document){
  ...
  // - Just replace and assign to 'MapStyles' the new11 style array
  ...
  $(document).on('click', Selector, function (e) {
      ...
      if(uri) {
        ...
        if(link) {
          ...
          $.error('Error creating new11 stylsheet link element.');
        }
      }
      else {
